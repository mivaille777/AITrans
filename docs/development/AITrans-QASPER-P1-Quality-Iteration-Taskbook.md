...
> 状态：执行中（Q1-0、Q1-1 已完成；Q1-2 人工事实质量门未通过；用户要求暂时跳过 Q1-3；Q1-4 消融已完成、R0 保留默认；Q1-5 入口审查为 no-go，Full1005/Holdout905 尚未启动，P2 不启动）；原始质量基线提交 `e2ac8838658133a4f83086b3cf486f488840bbf8`；制定日期：2026-09-24。
...
**入口审查（2026-09-24）：**用户要求跳过 Q1-3 后已完成 Q1-4，但无 RAPTOR 变体入围；Q1-2 的人工事实质量门仍未通过。现无可冻结的质量候选，故按上述门槛记录 Q1-5 no-go，不启动没有候选对照的 Full1005/Holdout905，也不标记 Q1-5 晋级完成。证据矩阵、同题 CI 与恢复条件见 [`qasper-p1-q1-5-gate-review.md`](qasper-p1-q1-5-gate-review.md)。
