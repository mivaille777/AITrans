export const companionLayoutClassNames = {
  shell:
    "ait-chat-shell grid h-full min-h-0 grid-cols-1 overflow-y-auto min-[960px]:grid-cols-[288px_minmax(0,1fr)] xl:grid-cols-[300px_minmax(0,1fr)_320px] xl:grid-rows-[minmax(0,1fr)] xl:overflow-hidden",
  historyPanel:
  ...
  contextPanel:
    "ait-chat-context-panel ait-scroll-panel order-3 min-h-0 max-h-[420px] overflow-y-auto overscroll-contain border-t border-slate-200 bg-white min-[960px]:col-span-2 xl:order-3 xl:col-span-1 xl:h-full xl:max-h-none xl:border-l xl:border-t-0",
  chatColumn:
