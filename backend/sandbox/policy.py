...
MAX_WORKSPACE_SNAPSHOT_ENTRIES = 4096
MAX_WORKSPACE_SNAPSHOT_FILES = 114
MAX_WORKSPACE_SNAPSHOT_FILE_BYTES = 20 * _MIB
MAX_WORKSPACE_SNAPSHOT_TOTAL_BYTES = 70 * _MIB
